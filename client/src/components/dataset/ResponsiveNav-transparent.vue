  ...
  <div class="min-h-full bg-gradient-to-r from-sky-400 to-indigo-500 ">
        ...
        <div class="flex items-center justify-between h-16">
          <div class="flex items-center grow ">
            <div class="flex-shrink-0">
              ...
              <div class="text-white text-xl font-bold"> Resolution</div>
            </div>
            ...
            <div class="hidden md:block">
              <div class="ml-10 flex items-baseline space-x-4">
                <a
                  ...
                  :href="item.href"
                  :class="[
                    item.current ? ' text-white' : 'text-gray-300 hover:bg-blue-600 hover:text-white',
          ...
          <div class="hidden md:block">
            <div class="ml-4 flex items-center md:ml-6">
              ...
              <button
                type="button"
                class=" p-1 rounded-full text-white hover:text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white"
              >
                  ...
                  >
                    <MenuItem v-for="item in userNavigation" :key="item.name" v-slot="{ active }">
                      <a
                        ...
                        :href="item.href"
                        :class="[active ? 'bg-gray-100' : '', 'block px-4 py-2 text-sm text-white']"
                        >{{ item.name }}</a
                      >
                    </MenuItem>
                  </MenuItems>
          ...
          <div class="-mr-2 flex md:hidden">
            <!-- Mobile menu button -->
            <DisclosureButton
              class=" inline-flex items-center justify-center p-2 rounded-md text-white hover:text-white hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white"
            >
      ...
      <DisclosurePanel class="md:hidden">
        ...
        <div class="pt-4 pb-3 border-t border-gray-700">
          <div class="flex items-center px-5">
            ...
            <button
              type="button"
              class="ml-auto  flex-shrink-0 p-1 rounded-full text-white hover:text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white"
            >
              <span class="sr-only">View notifications</span>
          ...
          <div class="mt-3 px-2 space-y-1">
            <DisclosureButton
              ...
              as="a"
              :href="item.href"
              class="block px-3 py-2 rounded-md text-base font-medium text-white hover:text-white hover:bg-gray-700"
              >{{ item.name }}</DisclosureButton
            >
          </div>
        </div>
    ...
    <header class="">
      <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
        <h1 class="text-3xl font-bold text-blue-900">SMI Population</h1>
      </div>
    </header>
    <main>
