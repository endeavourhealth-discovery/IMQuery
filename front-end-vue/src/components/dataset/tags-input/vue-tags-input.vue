...
>>>>>>> parent of 4247fee (1. added search functionality for profiles (and content definition), 2. restructured project and removed all unnecessary components, state, etc.)
              class="ti-icon-undo"
